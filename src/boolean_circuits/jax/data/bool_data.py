...
def generate_complete_bin_data(key, dim: int) -> Int[Array, "n_combs {dim}"]:
    """
    Generate all combinations of arrays of binary data length `dim`, return shuffled.
    """
    x = jnp.array(list(itertools.product([0, 1], repeat=dim)))
